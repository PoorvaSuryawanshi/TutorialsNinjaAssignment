...
public class TutorialsNinjaDemo {
	...
	public static  void orderCamera() {
	...
	public  static void orderProductIphone() {
	...
	public static String removeLastCharacterFromMessage(String str) {
	...
	public static void checkoutIphone() throws InterruptedException {
		...
		WebElement homeScreen = new WebDriverWait(driver,Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ul[@class='breadcrumb']//a[@href='http://tutorialsninja.com/demo/index.php?route=common/home']")));
		homeScreen.click();
	...
	static public void orderProductMacBook() throws InterruptedException {
	...
	public static void  applyCouponCode() {
	...
	public static void accountAndBillingDetails() throws InterruptedException {
